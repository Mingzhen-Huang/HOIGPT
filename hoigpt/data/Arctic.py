...
class HOIDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        cfg.DATASET.JOINT_TYPE = 'arctic'
        self.name = "arctic"
        self.njoints = 15
        
        # Path to the dataset
        data_root = cfg.DATASET.ARCTIC.ROOT
        ...
        self.hparams.max_motion_length = cfg.DATASET.ARCTIC.MAX_MOTION_LEN
        self.hparams.min_motion_length = cfg.DATASET.ARCTIC.MIN_MOTION_LEN
        self.hparams.max_text_len = cfg.DATASET.ARCTIC.MAX_TEXT_LEN
        self.hparams.unit_length = cfg.DATASET.ARCTIC.UNIT_LEN
        ...
        if cfg.TRAIN.STAGE == "vae":
            ...
            self.hparams.std_text = cfg.DATASET.ARCTIC.STD_TEXT
...
class ALLDataModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        # super().__init__(cfg=cfg, collate_fn=humanml3d_collate)
        super().__init__(collate_fn=humanml3d_collate)
        self.cfg = cfg
        self.save_hyperparameters(logger=False)
        ...
        # Path to the dataset
        data_root = cfg.DATASET.ALL.ROOT
        # self.data_root = data_root
        self.hparams.data_root = data_root
        # import pdb; pdb.set_trace()
        self.hparams.text_dir = pjoin(data_root, "texts")
...
class HOISYModule(BASEDataModule):
    def __init__(self, cfg, **kwargs):
        ...
        # Basic info of the dataset
        cfg.DATASET.JOINT_TYPE = 'arcticsy'
        self.name = "arcticsy"
        self.njoints = 15
        
        # Path to the dataset
        data_root = cfg.DATASET.ARCTICSY.ROOT
        self.hparams.data_root = data_root
        self.hparams.text_dir = pjoin(data_root, "texts")
        self.hparams.motion_dir = pjoin(data_root, 'new_joints')
        ...
        # Length of the dataset
        self.hparams.max_motion_length = cfg.DATASET.ARCTICSY.MAX_MOTION_LEN
        self.hparams.min_motion_length = cfg.DATASET.ARCTICSY.MIN_MOTION_LEN
        self.hparams.max_text_len = cfg.DATASET.ARCTICSY.MAX_TEXT_LEN
        self.hparams.unit_length = cfg.DATASET.ARCTICSY.UNIT_LEN
        ...
        if cfg.TRAIN.STAGE == "vae":
            ...
            self.hparams.code_format = cfg.DATASET.CODE_FORMAT
            self.hparams.task_path = cfg.DATASET.TASK_PATH
            self.hparams.std_text = cfg.DATASET.ARCTICSY.STD_TEXT
            self.Dataset = Text2MotionDatasetCB
        elif cfg.TRAIN.STAGE == "token":
            self.Dataset = Text2MotionDatasetToken
            self.DatasetEval = Text2MotionDatasetToken
